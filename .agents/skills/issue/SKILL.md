...
When both trackers are possible, or neither is obvious, follow the `ask` skill before
...
Stuck on Priority or Effort: follow the `ask` skill rather than defaulting to Medium.
