...
| `tools/*/commands/deslop`                | `/deslop` audits the current branch's changes for AI-generated code smell (over-engineering and style tells) and applies only what you confirm | When you type the command                                        |
