...
Guidelines for minimal, high-quality JSDoc across the codebase: document exported type
properties and configuration options, add context that TypeScript types do not convey, and
provide examples for non-obvious APIs.
