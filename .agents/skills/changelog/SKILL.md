...
4. **Formats Professionally**: Creates clean, structured changelog entries following the repo's conventions.
5. **Filters Noise**: Excludes internal commits (`refactor`, `test`, etc.).
6. **Follows Best Practices**: Applies changelog guidelines and your brand voice.

This monorepo uses Changesets for version management and generates the changelog from changeset entries.
